...
extends SimplifyMiningToolItem {
    ...
    public SimplifyShovelItem(SimplifyToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
        super(material, attackDamage, attackSpeed, BlockTags.SHOVEL_MINEABLE, settings);
        this.effectiveBlocks = BlockTags.SHOVEL_MINEABLE;
    }
