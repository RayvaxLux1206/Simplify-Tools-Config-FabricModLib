...
public class SimplifyHoeItem extends SimplifyMiningToolItem {
    ...
    public SimplifyHoeItem(FixerSettings fix, float attackDamage, float attackSpeed, Settings settings) {
        super(fix, attackDamage, attackSpeed, BlockTags.HOE_MINEABLE, settings);
    }
