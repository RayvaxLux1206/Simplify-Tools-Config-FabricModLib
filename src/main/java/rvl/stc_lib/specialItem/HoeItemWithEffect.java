...
import rvl.stc_lib.SimplifyHoeItem;
import rvl.stc_lib.SimplifyToolMaterial;

public class HoeItemWithEffect extends SimplifyHoeItem {
    ...
    public HoeItemWithEffect(FixerSettings fix, float attackDamage, float attackSpeed, @Nullable RegistryEntry<StatusEffect> effectOnTarget, @Nullable RegistryEntry<StatusEffect> effectOnAttacker, boolean hasHitEffect, boolean hasAttackerEffect, int effectTime, int amplifier, Settings settings) {
