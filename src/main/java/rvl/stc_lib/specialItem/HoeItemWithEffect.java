...
public class HoeItemWithEffect extends SimplifyHoeItem {
    ...
    public HoeItemWithEffect(SimplifyToolMaterial material, float attackDamage, float attackSpeed, @Nullable StatusEffect effectOnTarget, @Nullable StatusEffect effectOnAttacker, boolean hasHitEffect, boolean hasAttackerEffect, int effectTime, int amplifier, Settings settings) {
