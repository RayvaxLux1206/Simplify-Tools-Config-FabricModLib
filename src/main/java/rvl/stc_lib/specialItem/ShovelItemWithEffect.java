...
public class ShovelItemWithEffect extends SimplifyShovelItem {
    ...
    public ShovelItemWithEffect(SimplifyToolMaterial material, float attackDamage, float attackSpeed, @Nullable RegistryEntry<StatusEffect> effectOnTarget, @Nullable RegistryEntry<StatusEffect> effectOnAttacker, boolean hasHitEffect, boolean hasAttackerEffect, int effectTime, int amplifier, Settings settings) {
