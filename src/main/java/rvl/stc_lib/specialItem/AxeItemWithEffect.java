...
public class AxeItemWithEffect extends SimplifyAxeItem {
    ...
    public AxeItemWithEffect(SimplifyToolMaterial material, float attackDamage, float attackSpeed, @Nullable StatusEffect effectOnTarget, @Nullable StatusEffect effectOnAttacker, boolean hasHitEffect, boolean hasAttackerEffect, int effectTime, int amplifier, Settings settings) {
