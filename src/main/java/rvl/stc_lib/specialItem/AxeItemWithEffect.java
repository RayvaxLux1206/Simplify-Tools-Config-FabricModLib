...
import rvl.stc_lib.SimplifyAxeItem;

public class AxeItemWithEffect extends SimplifyAxeItem {
    ...
    public AxeItemWithEffect(FixerSettings fix, float attackDamage, float attackSpeed, @Nullable RegistryEntry<StatusEffect> effectOnTarget, @Nullable RegistryEntry<StatusEffect> effectOnAttacker, boolean hasHitEffect, boolean hasAttackerEffect, int effectTime, int amplifier, Settings settings) {
