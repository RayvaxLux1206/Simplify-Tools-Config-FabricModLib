...
public class PickaxeItemWithEffect extends SimplifyPickaxeItem {
    ...
    public PickaxeItemWithEffect(FixerSettings fix, float attackDamage, float attackSpeed, @Nullable RegistryEntry<StatusEffect> effectOnTarget, @Nullable RegistryEntry<StatusEffect> effectOnAttacker, boolean hasHitEffect, boolean hasAttackerEffect, int effectTime, int amplifier, Settings settings) {
