...
public class PickaxeItemWithEffect extends SimplifyPickaxeItem {
    ...
    public PickaxeItemWithEffect(SimplifyToolMaterial material, float attackDamage, float attackSpeed, @Nullable StatusEffect effectOnTarget, @Nullable StatusEffect effectOnAttacker, boolean hasHitEffect, boolean hasAttackerEffect, int effectTime, int amplifier, Settings settings) {
