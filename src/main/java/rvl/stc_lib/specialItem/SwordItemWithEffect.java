...
public class SwordItemWithEffect extends SimplifySwordItem {
    ...
    public SwordItemWithEffect(SimplifyToolMaterial material, float attackDamage, float attackSpeed, @Nullable StatusEffect effectOnTarget, @Nullable StatusEffect effectOnAttacker, boolean hasHitEffect, boolean hasAttackerEffect, int effectTime, int amplifier, Settings settings) {
