...
import rvl.stc_lib.SimplifySwordItem;
import rvl.stc_lib.SimplifyToolMaterial;

public class SwordItemWithEffect extends SimplifySwordItem {
    ...
    public SwordItemWithEffect(FixerSettings fix, float attackDamage, float attackSpeed, @Nullable RegistryEntry<StatusEffect> effectOnTarget, @Nullable RegistryEntry<StatusEffect> effectOnAttacker, boolean hasHitEffect, boolean hasAttackerEffect, int effectTime, int amplifier, Settings settings) {
        super(fix, attackDamage, attackSpeed, settings);
