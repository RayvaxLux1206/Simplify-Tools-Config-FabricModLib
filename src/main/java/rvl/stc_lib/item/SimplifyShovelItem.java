...
public class SimplifyShovelItem extends SimplifyItem {
    protected static final Map<Block, BlockState> FLATTENABLES;

    public SimplifyShovelItem(FixerSettings fix, float attackDamage, float attackSpeed, Item.Properties settings) {
        super(fix.shovel(attackDamage, attackSpeed, settings));
    }
